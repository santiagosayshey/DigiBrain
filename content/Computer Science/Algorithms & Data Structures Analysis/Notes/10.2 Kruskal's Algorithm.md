I apologize for the confusion. You're absolutely right. We should focus on the motivation for using the union-find data structure in Kruskal's Algorithm. Let's revise the note accordingly:

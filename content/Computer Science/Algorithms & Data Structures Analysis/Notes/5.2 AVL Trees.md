...
| ---------------- | ---------------------------- | ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| LL (Left-Left)   | Left subtree of left child   | Single Right Rotation at Node  | ```   A   ```<br>```  /   ```<br>``` B   ```<br>```/   ```<br>```C```                                                                                                         | ```   B   ```<br>```  / \ ```<br>```A   C``` |
| RR (Right-Right) | Right subtree of right child | Single Left Rotation at Node   | ```A   ```<br>```   \   ```<br>```    B```<br>```     \   ```<br>```      C```                                                                                                | ```   B   ```<br>```  / \ ```<br>```A   C``` |

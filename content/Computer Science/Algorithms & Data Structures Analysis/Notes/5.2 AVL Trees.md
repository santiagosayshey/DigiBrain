...
| Imbalance Type   | Condition                    | Rotations Needed               | Example | Final Structure |
| ---------------- | ---------------------------- | ------------------------------ | ------- | --------------- |
| LL (Left-Left)   | Left subtree of left child   | Single Right Rotation at Node  | A       | B               |
|                  |                              |                                | /       | / \             |
|                  |                              |                                | B       | A   C           |
|                  |                              |                                | /       |                 |
|                  |                              |                                | C       |                 |
| RR (Right-Right) | Right subtree of right child | Single Left Rotation at Node   | A       | B               |
|                  |                              |                                | \       | / \             |
|                  |                              |                                | B       | A   C           |
|                  |                              |                                | \       |                 |
|                  |                              |                                | C       |                 |
| LR (Left-Right)  | Right subtree of left child  | Left Rotation at Left Child,   | A       | C               |
|                  |                              | then Right Rotation at Node    | /       | / \             |
|                  |                              |                                | B       | B   A           |
|                  |                              |                                | \       |                 |
|                  |                              |                                | C       |                 |
| RL (Right-Left)  | Left subtree of right child  | Right Rotation at Right Child, | A       | C               |

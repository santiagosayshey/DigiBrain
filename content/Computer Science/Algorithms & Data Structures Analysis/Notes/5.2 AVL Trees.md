...
| Imbalance Type   | Condition                    | Rotations Needed               | Example and Intermediate Structures                                                                                                                                           | Final Structure                              |
| ---------------- | ---------------------------- | ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| LL (Left-Left)   | Left subtree of left child   | Single Right Rotation at Node  | ![[Pasted image 20240606171244.png]]<br><br><br><br>                                                                                                                          | ![[Pasted image 20240606171301.png]]<br><br> |
| RR (Right-Right) | Right subtree of right child | Single Left Rotation at Node   | ![[Pasted image 20240606171358.png]]<br><br><br><br>                                                                                                                          | ![[Pasted image 20240606171408.png]]<br><br> |
| LR (Left-Right)  | Right subtree of left child  | Left Rotation at Left Child,   | ```   A   ```<br>```  /   ```<br>``` B   ```<br>```   \   ```<br>```    C```<br>**Intermediate:**<br>```   A   ```<br>```  /   ```<br>``` C   ```<br>``` /   ```<br>```B```   | ```   C   ```<br>```  / \ ```<br>```B   A``` |
|                  |                              | then Right Rotation at Node    |                                                                                                                                                                               |                                              |
| RL (Right-Left)  | Left subtree of right child  | Right Rotation at Right Child, | ```A   ```<br>```   \   ```<br>```    B```<br>```  /   ```<br>``` C```<br>**Intermediate:**<br>```A   ```<br>```   \   ```<br>```    C```<br>```     \   ```<br>```      B``` | ```   C   ```<br>```  / \ ```<br>```A   B``` |
|                  |                              | then Left Rotation at Node     |                                                                                                                                                                               |                                              |
```
   A
  /
 B

...
>
> Hash **collisions** occur when multiple keys map to the same array index. There are two main approaches to handle collisions: open hashing (separate chaining) and closed hashing (open addressing).
>
> 1. Open Hashing (Separate Chaining):
>    - In open hashing, each array index points to a linked list or a dynamic array.

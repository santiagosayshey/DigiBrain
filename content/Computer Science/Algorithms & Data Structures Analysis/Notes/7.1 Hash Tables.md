...
These callouts separate the information into distinct sections for collisions and hashing techniques, open hashing with chaining, and closed hashing with probing. The callout for probing includes the specific details about linear probing, such as the search and deletion processes.

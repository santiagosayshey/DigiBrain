...
> [!idea] Process
> A process is an execution stream that maintains a process state, i.e. it is a **program that is being executed**. Multiple instances of a program can exist as separate processes.
> 

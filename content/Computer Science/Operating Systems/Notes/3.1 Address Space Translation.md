...
> 2. MMU checks if 500 < 2000 (Bounds)
> 3. Address is within bounds, so it's valid
> 4. MMU calculates physical address: 1000 + 500 = 1500
> 5. MMU returns physical address 1500 to CPU
> 
> **Protection in Action:**
> If Process A tries to access address 3000:
> 1. MMU checks if 3000 < 2000 (Bounds)
> 2. 3000 > 2000, out of bounds
> 3. MMU triggers a memory access violation before doing any address translation

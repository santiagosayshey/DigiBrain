...
>
> **Key Components:**
> - **Logical Address:** Used by CPU and programs
> - **Physical Address:** Actual location in physical memory
> - **Base Register:** Starting address of a process in physical memory
> - **Bounds Register:** Size of the process's address space
> - **Mode Bit:** Indicates CPU mode (kernel or user)
>
> **Core Functions:**
> - **Address Translation:** Converts logical to physical addresses
> - **Memory Protection:** Prevents unauthorized access
> - **Access Control:** Enforces different privileges for kernel and user modes
>
> **Translation Process:**
> 1. Receive logical address from CPU
> 2. Add base register value
> 3. Check against bounds register
> 4. Return physical address or trigger exception

> [!example] MMU in Action: Address Translation
> Consider a system where Process A is running in user mode:
>
> **Scenario Setup:**
> - Base Register: 1000
> - Bounds Register: 2000 (Process A's size)
> - Logical Address Requested: 500
>
> **Step-by-Step Translation:**
> 1. CPU requests logical address 500
> 2. MMU adds base: 1000 + 500 = 1500
> 3. MMU checks if 1500 < (1000 + 2000)
> 4. Address is within bounds, so it's valid
> 5. MMU returns physical address 1500 to CPU
>
> **Protection in Action:**
> - If Process A tries to access address 3000:
>   1. MMU calculates: 1000 + 3000 = 4000
>   2. 4000 > (1000 + 2000), out of bounds
>   3. MMU triggers a memory access violation
>
> This mechanism ensures **memory isolation between processes** and **protects critical system areas**.

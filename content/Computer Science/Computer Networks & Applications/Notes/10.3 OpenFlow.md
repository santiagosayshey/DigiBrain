...
I would like your assistance in writing concise, modular notes on the topic of [OpenFlow protocol] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
This note leads  on from my note on SDNs, so theres no need to rehash anything from there. Ive attached it below. 

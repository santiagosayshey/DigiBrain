...
> ![[aaa.png]]
> 
> This is starting to get a bit unwieldly, maybe we can we use a single ACK to determine if the message was received or not. We can do this by adding the SQ number to the ACK. Adding the right sequence number indicates an ACK, and the wrong one indicates a NAK.
> 
> ![[asdasdasdasdas.png]]
> 
> ![[Group 3.png]]

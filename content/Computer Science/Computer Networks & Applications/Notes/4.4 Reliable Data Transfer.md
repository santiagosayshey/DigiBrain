...
> [!consider] RTD2.0 - 
> Obviously, reliable channels are not feasible. **Things WILL go wrong!** We need to deal with bit errors and packet loss. How? Error Detecting Methods? Checksums, ACKS / NAKS, etc

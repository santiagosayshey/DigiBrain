...
> [!consider] RTD2.0 - 
> Obviously, reliable channels are not feasible. **Things WILL go wrong!** We need to deal with bit errors and packet loss. How?
> - **Acknowledgements (ACKs)**: Receiver explicitly tells sender that the packet was received OK.

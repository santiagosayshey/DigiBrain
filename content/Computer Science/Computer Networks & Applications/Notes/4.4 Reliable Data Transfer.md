...
> 
> Obviously, this is not feasible. **Things WILL go wrong!** We need to deal with bit errors and packet loss. How? Error Detecting Methods? How? MOAR HEADERS! (Checksums)

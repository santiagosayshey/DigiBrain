...
I would like your assistance in writing concise, modular notes on the topic of [Address Resolution Protocol] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
This example is overly verbose, introduces bias and actively hinders the learning experience. 
```

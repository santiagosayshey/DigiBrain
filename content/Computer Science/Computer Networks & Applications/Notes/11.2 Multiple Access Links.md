...
I would like your assistance in writing concise, modular notes on the topic of [Multiple Access Links] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
Motivation to introduce the issue of trying to communicate over a share medium. - like shouting over a crowded room.
- idea solutions. Direct links fix this, but theyre exensive and not scalable. Theyre also secure. Now talk about using shared mediums like broadca

...
I would like your assistance in writing concise, modular notes on the topic of [CSMA] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
Talk about Carrier Sense Multiple Access. Write a consider callout for how its different to ALOHA. Here are my ntoes on that for reference:

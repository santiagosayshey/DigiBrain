...
I would like your assistance in writing concise, modular notes on the topic of [Security] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- This note acts as the footnote for my computer networks and applications course.
	- Start of introducing a very general motivation to say why computer security is important. Why we need testing. Human error is the most common reason for vulnerabilities.
	- After this, ill ask you for more stuff, but dont add anything else for now

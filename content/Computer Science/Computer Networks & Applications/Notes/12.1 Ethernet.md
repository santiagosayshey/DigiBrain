...
I would like your assistance in writing concise, modular notes on the topic of [Ethernet] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- Give a brief history point on the BUS topology by Metcalfe, say how we now have evolved to 10Gbps and up. This applies only to the motivation callout. Don't go over bored with this please. Leave space an image for me to put the topology diagram. You would then say something that would introduce an idea for ethernet, and why its needed
- Ethernet idea callout. Explain what it is, leave space for an image for me to describe the ethernet frame. 
...
- Failure to follow these instructions will result in the response being deemed unsatisfactory and may lead to termination of the interaction. To make sure you unde

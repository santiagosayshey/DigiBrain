...
I don't want you to write the entire note for now, just focus on the motivation and initial idea callout for routing. The motivation should be stating that the goal of routing is x. We do this by abstracting networks into graphs, then go into a small overview of defining grapgs in

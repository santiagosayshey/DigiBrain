...
I would like your assistance in writing concise, modular notes on the topic of [Switches] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- Context of ethernet. No need to rehash stuff about ethernet.
- talk about:
	- device of link layer
	- transparent
	- plug n play
	- self learning

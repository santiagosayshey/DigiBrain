...
I would like your assistance in writing concise, modular notes on the topic of [Error Detection & Correction] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
Talk about EDC bits. leave space for an image.

...
> - Received ACKs: 1, 2
> - Packet 3 is lost
> - Receiver discards packet 4 (and any other packets sent) and sends ACK 2
...
> - **The sender only needs the FINAL ACK** of a window size to say that all previous packets have been receieved
>   

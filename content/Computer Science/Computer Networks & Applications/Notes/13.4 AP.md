...
I would like your assistance in writing concise, modular notes on the topic of [AP cryptography protocls] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- If you dont understand what this is, please ask and I will verify
- Go through all versions 1.0, 2.0, etc Write an idea callout for each of them and briefly describe:
	- What issues there are
	- How it solves it
- For example, ap5.0 solves autheentication using public keys

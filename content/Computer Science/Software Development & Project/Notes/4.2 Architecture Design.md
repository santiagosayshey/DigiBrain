...
idea - architecture style
- pattern of organisation
	- client / server, layered, component reuse
	- a standard implemnentation
	- no one size fits all


idea - sys organisation
- the overall strategy
- three major styles (idea for each)
	- shared data repo
	- shared services and servers (client server)
	- abstract machine (layered)
	- explain and give examples for all of these
		- mermaid diagram if nessecary
	- pros and cons for all (in a table)
- can be used sperately or together
- 
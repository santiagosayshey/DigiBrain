...
> | 2. Sprint Planning | Product owner proposes a set of user stories for sprint (added to product backlog), dev team collaboratively decides which items will be added to the sprint backlog. They make the FINAL decision. Scrum Master facilitates meeting. | Choosing to implement user login and profile creation features for a 2-week sprint |

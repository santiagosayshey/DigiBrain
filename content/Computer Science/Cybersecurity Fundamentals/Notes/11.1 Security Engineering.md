...
I would like your assistance in writing concise, modular notes on the topic of [Security Engineering] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
Cover the following:
- what is it?
- why is it important? (finding issues early is cheaper in the long run to fix over the dev cycle)
- frameworks and standards
- make a markdown table to show the 10 principles of owasp
...
5. Defence in Depth  
6. Zero Trust (users, third-party systems, ect)  
7. Security by Default  
8. Fail Securely  
9. Avoid Security by Obscurity  
10.Risk-Informed

give a column for explanation and example too

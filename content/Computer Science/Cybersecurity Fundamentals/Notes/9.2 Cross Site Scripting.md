...
I would like your assistance in writing concise, modular notes on the topic of [Cross Site Scripting] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
I would like you to cover cross site scripting. Stored XSS. Session Hijacking. Reflected XSS. refkected vs stored. XSS defence. Preventing XSS in php. Preventing session hijacking. Content security policy.

Please add as many examples as you can! Talk about it using javascript unless otherwise stated! Ive attached my previous notes on javascript. Please understand that this note follows on from this, so theres no need to rehash stuff. This is below:

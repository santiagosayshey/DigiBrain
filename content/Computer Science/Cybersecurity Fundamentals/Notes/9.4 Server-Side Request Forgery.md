...
I would like your assistance in writing concise, modular notes on the topic of [Server-Side Request Forgery] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- consider callout to say why we would use this over cross site request forgery
- idea callout to explain what it is

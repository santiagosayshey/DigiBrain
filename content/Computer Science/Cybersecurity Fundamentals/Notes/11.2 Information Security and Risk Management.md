...
- Types of Controls
	...
	- detective
	- corrective
ive also provided some images that you may want to talk about
...
> [!idea] Risks
>
> Risks refer to the potential for loss or damage when a threat exploits a vulnerability. Identifying risks involves analyzing threats, vulnerabilities, and their potential impact on information assets. Examples of risks include:
...
>
> **Risk Mitigation**: Implement countermeasures (controls) to reduce the likelihood or impact of risks. This includes:
...
> An organization identifies a risk of a data breach with a high likelihood and high impact. They implement encryption (preventive control), monitor network activity (detective control), and establish a data recovery plan (corrective control) to mitigate the risk.

...
I would like your assistance in writing concise, modular notes on the topic of [summarising my week 9 notes!] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
All you need to do is write a single idea callout that encaspulates the key ideas 

...
I would like your assistance in writing concise, modular notes on the topic of [Cross-Site Request Forgery] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- A short review of cookies and session tokens
- Idea for CSRF
- Example CSRF (Procedure)
- Consideration of difference between reflected XSS
- Consideration to prevent CSRF
- Same site cookies

...
I would like your assistance in writing concise, modular notes on the topic of [Legal and Ethics] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- definition for both in an idea callout. Examples for both (is it a legal or ethical issue?) talk about how, for legal issues it usually depends on a 
- keywords
	- privacy

...
I would like your assistance in writing concise, modular notes on the topic of [Cyber legality] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
This note is under the context of Cybersecurity fundamentals. I want you to talk about the following:
- motivation on why these things are important
- definition for both in an idea callout. Examples for both (is it a legal or ethical issue?) talk about how, for legal issues it usually depends on a  lot of factors and there are no clear cut answers. talk about category of laws and expand on cyber laws
- keywords
	- privacy
	- freedom of speech, expression
	- surveillance and monitoring
	- laws governing the internet
	- laws controlling cybercrime
	- laws governing surveillance
- talk about reporting laws
- other related cyber laws
• ASIO Act – defines and grants powers to ASIO  
• Intelligence Services Act – grants powers to ASIO, ASD, ASIS  
• Criminal Code Act – regulates all crimes, and includes internet-based crimes  
• Electronic Transaction Act – facilitates ecommerce  
• National Security Information Act – prevents disclosure of federal crime and  
civil proceedings
- legal considerations in pen testing - compliance, liability and documentation

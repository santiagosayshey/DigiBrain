...
- Motivation that leads in from digital forensices. Ie, weve already identified why we need it, heres one of the things we can use to do it.
- idea for stenography
	- in text
	- in images
- Steganalysis idea
- 

You're absolutely right—there was a mistake in the stack order. The parameters should indeed be placed on the stack in reverse order, with the last parameter pushed first. Here's the corrected version:

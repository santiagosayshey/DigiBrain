...
I would like your assistance in writing concise, modular notes on the topic of [World Hunger (Narveson)] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
I have already written a motivation and consider callout: 

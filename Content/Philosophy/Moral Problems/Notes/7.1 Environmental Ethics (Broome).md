...
> [!consider] Comparing Government Strategies (Broome's View)
>
> Broome analyzes several ways governments might approach climate change under their **duty of goodness**. These aren't always mutually exclusive but represent different focuses or levels of ambition:
>
> | Strategy/Concept           | Description/Goal                                             | Broome's Perspective/Evaluation                                         |
> | :------------------------- | :----------------------------------------------------------- | :---------------------------------------------------------------------- |
> | **Efficiency** | Correct market failures (e.g., unpaid costs of pollution/externalities) to improve overall resource use and welfare. | **Primary Goal:** Highly desirable. Directly addresses a core economic problem related to emissions. |
> | **Optimisation** | Select policies that produce the absolute maximum total good across society (using cost-benefit analysis).         | **Cautious Aim:** Theoretically aligns with 'goodness' but risky if it requires unjust actions or ignores fairness. |
> | **Compensation** | Use government resources (e.g., policy revenue) to mitigate harm or negative impacts of climate/policies on specific groups. | **Supporting Tool:** Important for making policies (especially efficiency-based ones) fairer and politically viable, not a standalone strategy. |
>
> **Broome's Preference:**
> While all relate to the government's duty of goodness, Broome emphasizes **prioritizing efficiency**. Correcting the externality of greenhouse gas emissions is a clear way governments can improve collective well-being. He advises caution regarding pure optimisation due to potential conflicts with justice, and sees compensation as a vital tool to ensure fairness while pursuing efficient policies.
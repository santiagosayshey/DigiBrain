...
| 3         | Idea             | Responsibility Gaps and Sparrows View | Explain what it is - a situtationin which it is unclear who we can justifiably hold responsible for an outcome. Who can we hold responsible for a death caused by a driver less car? <br><br>Sparrow suggests that ebcuase of therse responsibility gaps, it is not fair to hold people responsible for what theycannot fully predict or direcly control. So we cannot hold either programmers or car owners resonsible for the death as a result of a driverless car. <br><br>Hevelke and Nida-Rumelin argue that this holds, because intuitively, if we hold manufacturers liable for these deaths, they have an incentive to stop manufacturing cars and this would be overall bad (because driverless cars are safer overall) |

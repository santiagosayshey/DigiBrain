...
I would like your assistance in writing concise, modular notes on the topic of [World Hunger (specifically in the context of philsophical ethics and singers infamous paper)] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
lets start with a motivation callout. brief background on world hunger.

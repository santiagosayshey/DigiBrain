...
| 5         | Idea             | Cluster Concept and Personhood (maybe come up with a better name) | Warren believes that we do not need a set of requirements to be considered a person. why? because personhood is a cluster concept. <br><br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

...
| --------- | ---------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Abortion          Briefly explain what abortion is, reference Roe vs Wade. Explain its controversy and why its allowed / not allowed in some places but not others, which then leads into our note. <br><br>we should also define some quick terminology here, fetus (not medically correct but we refer to as the unborn from conception to birth(, infant (after birth)) .  .  .  |
| 2         |                  |                                                                                                                                                                                                                                                                                                                                                                                     |

...
| --------- | ---------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Abortion              Briefly explain what abortion is, reference Roe vs Wade. Explain its controversy and why its allowed / not allowed in some places but not others.  .  |
| 2         |                  |                                                                                                                                                                             |

...
I would like your assistance in writing concise, modular notes on the topic of [Utalitarianism] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
motivation - a framework to quantify the rightness of our actions. why do we do the things that we do. how do we know if the things we do are good things? 

idea - utalitarianism. what does it tell us about the things that we do? 

idea - extreme utalitarianism

idea - restricted utalitarianism

example - the trolley problem and what utalitarinism suggests

no other callouts please

...
| 2         | Idea             | Privacy                     | Rachels suggests that privacy is valuable insofar as it is needed for us to maintain the sorts of relationships with others that we value. Give some examples of this - 3 levels of relations with different levels of privacy. <br><br>then ask the question - why else might we value privacy? (rachels uses these examples to show theyre not the true reasons. ) |
...
| 5         | Consider         | The Confidentiality Account | The third is that it prevents others to gain access to information that can harm us.                                                                                                                                                                                                                                                                                 |

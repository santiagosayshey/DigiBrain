...
I would like your assistance in writing concise, modular notes on the topic of [Euthenasia] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- voluntary - performed with a parients voluntary consent (also note that what this actually is, is quite controversal but for the sake )

example - a well known case study of euthenasia. 

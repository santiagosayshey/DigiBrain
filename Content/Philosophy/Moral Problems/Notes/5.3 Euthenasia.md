...
idea - euthenasia. just a general overview with a clear distinction of active and passive euthenasia. also note that while there are many countries where euthenasia is permitted (even active, list some), there are many countries where it is entirely illegal. 

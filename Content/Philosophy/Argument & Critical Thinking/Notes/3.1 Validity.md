...
I would like your assistance in writing concise, modular notes on the topic of [Analogous Form] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- i want to write a consider callout that explaids 

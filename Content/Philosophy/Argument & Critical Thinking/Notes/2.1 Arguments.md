...
I would like your assistance in writing concise, modular notes on the topic of [Arguments] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
idea - sentences
- not every sentence in argument can be a premise or a conclusion
- these sentences do not have to be logical - ie they dont have to be capable of being true or false
- premises and conclusions, do however, need to be able to be true or false

examples
- have you seen "interstellar"?
- you really should see "interstallar"!
- what are these?

idea - statements
- sentences that are capable of being true or false are known as statements

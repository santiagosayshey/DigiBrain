...
| --------- | ---------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Faulty Reasoning     - We know conceptually how to argue, you do x,y,x then evaluate soundness, validity and whatnot. <br> - People dont usually communicate like this in real world, and their reasoning is often faulty, so how do we actually identify this faulty reasoni ally  |
| 2         |                  |                                                                                                                                                                                                                                                                                     |

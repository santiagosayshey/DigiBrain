...
- **Topic for Notes:** Faulty Reasoning
...
| --------- | ---------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Faulty Reasoning      | - We know conceptually how to argue, you do x,y,x then evaluate soundness, validity and whatnot. <br> - People dont usually communicate like this in real world, and their reasoning is often faulty, so how do we actually identify this faulty reasoning and not fall into these traps?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 2         | Idea             | Fallacies             | - We've seen so far in deductive, inductive and abductive reasoning that the conclusions we work with often have an outright linear relationship. The more truthier the premises are, the more truthier the conclusion is. But this is not the case with faulty reasoning. These are fallacies. <br>- Formal fallacies are faults of the structure of the argument rather than its content. explain this.<br>- Informal fallacies are fauts of due to an error of fact, incomplete information or misjudgement. the difference here is that arguments of the same structure can either be an informal fallacy or not, but must either always be correct (is that the right word) or or incorrect regardless of content<br><br>key thing here is not to list all the types, but explain in general. you can list some if you want though, especially if youre going to give them as  an example in the next section. |
| 3         | Example          | Formal Fallacy        | Structure this a table please inside the callout. you can come up with columns.<br><br>1. Affirming the Consequent<br>2. Denying the Antecedent<br>3. The Undistributed Middle<br>4. Base Rate Neglect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 4         | Example          | Informal Fallacy      | Come up with an example yourself                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

...
I would like your assistance in writing concise, modular notes on the topic of [Abduction] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
- weve already talked about induction as ampliative reasoning - going beyond information
- sometimes we want to infer the cause of some information - causal reasoning.

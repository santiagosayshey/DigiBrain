...
I would like your assistance in writing concise, modular notes on the topic of [Syllogisms] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
motivation - we've seen 1 premise arguments that relate 1 classes, but what if we have 2 premises that relate 3 classes?

idea - syllogisms

example - syloigism example

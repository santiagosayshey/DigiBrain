...
| --------- | ---------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Reasoning in the Wild | There is more to critical thinking than venn diagrams and argument structure. Many of those who reason in the wild refuse to engage in rational argument, so it on the onus of those who do, to recognise this abuse and misuse. how do we do that? |
...
| 2   | Example | Persuasion        | We've already seen how to persuade people - we argue, using reasons, to convince other people to believe in opinions. Are there other ways to persuade people? <br>- Fear. Manipulation. Othering. Case study - Donald Trump on Mexican Immigrants (try to directly quote here). What do we quantify this as? An appeal to emotion.<br>- Give others. Echochambers, etc. |
| --- | ------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 3   | Idea    | Appeal to Emotion | Explain this process. Give examples (ill provide some images which you can explain)                                                                                                                                                                                                                                                                                      |
| 4   | Idea    | Rhetoric          | When we try to persuade people using means other than reasoning, we are engaged in what is called 'Rhetoric'. This is not nessecarily a bad thing - rhetoric is powerful persuasion, but we can often see that is used not for good.<br><br>what is it? talk about ethos, logos (being reasonable), pathos.                                                              |
|     |         |                   |                                                                                                                                                                                                                                                                                                                                                                          |

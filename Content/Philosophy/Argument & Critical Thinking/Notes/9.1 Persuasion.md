...
| 4         | Idea             | Rhetoric              | When we try to persuade people using means other than reasoning, we are engaged in what is called 'Rhetoric'. This is not nessecarily a bad thing - rhetoric is powerful persuasion, but we can often see that is used not for good. <br><br>what is it?                                                                                                                 |

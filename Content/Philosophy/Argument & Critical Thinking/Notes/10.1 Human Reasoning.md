...
| 3         | Consider         | Explaining the Error  | a few hypothesis - humans are bad at logical reasoning? visual heuristics? These visual biases provide shortcutrs that often result in base understanding to extrapolate to many trhings, but there are many errors in how we experience things. give examples of this.                                                |

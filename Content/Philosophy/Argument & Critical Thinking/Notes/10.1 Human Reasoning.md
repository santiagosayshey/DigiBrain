...
| --------- | ---------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | Why Fallacies?        | Logically we understand how to identify issues in faulty reasoning through fallacies, but what actually what gives way to these fallacies in the first place? Why dont people just reason properly? <br>- Were trying to set the stage for an idea of cognitive bias                                                                                                                                                                                                                                                                                              |
| 2         | Example          | Wason's Task          | Clearly explain the task with the 4 cards and explain in detail what is going on. Liken it to modus tollens and what you need to actually figure out.  <br><br>We also want to end on the fact that many people fail this task (over 90%)- why is this the case? dont answer, it leads directly into the next callout.                                                                                                                                                                                                                                            |
| 3         | Consider         | Explaining the Error  | a few hypothesis - humans are bad at logical reasoning? visual heuristics? These visual biases provide shortcutrs that often result in base understanding to extrapolate to many trhings, but there are many errors in how we experience things. give examples of this. light sources at the top, eyes on top of faces (flip eyes upside down, then flip the entire face upside down. it looks fine, but when you look at it right side up, its completely wrong (the eyes are flipped!!!)) also please leave space for two images for the face one that ill add. |
| 4         | Idea             | Cognitive Heuristics  | Errors in reasoning are often due to cognitive bias as a result of cognitive hueristics. Explain the diffence between reasoning with logic vs reasoning with heuristics. Explain that with heuritics is not bad,. in fact it makes intuitive reasoning very efficiency, but it can be misleading when applied to new domains. <br><br>then explicitly define cognitive bias and how it causes errors and why its hard to see.                                                                                                                                     |
...
> 
> [Image placeholder for Thatcher illusion - upside down face with inverted eyes looking normal]
> [Image placeholder for same face right-side up with inverted eyes looking disturbing]
> 

...
| 2         | Example          | Fallacies of Presumption | Asumming too much or something which is not warranted<br>- Begging the question (circular reasoning)<br>- False dichotomoy<br>- Slippery slopes<br><br>Give examples and explain each                                                                                                            |
| 3         | Example          | Fallacies of Ambiguity   | Using the meanings of words to twist meaning or create uncertainty<br>- Fallacy of Equivocation (can you also add a bit here to say if this is similar to the formal fallacy of undistributed middle)<br>- Fallacy of Composition<br>- Fallacy of Division<br><br>Give examples and explain each |

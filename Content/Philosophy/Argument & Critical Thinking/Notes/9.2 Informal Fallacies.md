...
| --------- | ---------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1         | Example          | Fallacies of Relevance   | Premises are not relevant to the conclusion<br>- Irrelevant conclusion<br>- Ad hominem<br>- Appeals to irrelevant authority, ignorance or popularity<br><br>Give examples and explain each |
| 2         | Example          | Fallacies of Presumption |                                                                                                                                                                                            |

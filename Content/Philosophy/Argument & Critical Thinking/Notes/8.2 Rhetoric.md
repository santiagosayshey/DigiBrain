...
| --------- | ---------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Consider         | Self Defence          | We must defend outselves against false use of rhetoric. how do we do this? we recognise the devices that are used - linguistic or visual techniques used to enhance the persuasiveness of a message.                                     |
| 2         | Idea             | Rhetorical Questions  | A question that is not intended to be answered as to prove a point. We ask them not because we want to know the answer, but because we want the askee to accept our answer for the question.<br><br>Give an example callout for this too |
| 3         | Idea             |                       |                                                                                                                                                                                                                                          |

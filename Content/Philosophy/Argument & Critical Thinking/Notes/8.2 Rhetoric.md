...
| --------- | ---------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|           | Consider         | Self Defence          | We must defend outselves against false use of rhetoric. how do we do this? we recognise the devices that are used - linguistic or visual techniques used to enhance the persuasiveness of a message. |
|           | Idea             | Rhetorical Questions  | A question that                                                                                                                                                                                      |
|           |                  |                       |                                                                                                                                                                                                      |

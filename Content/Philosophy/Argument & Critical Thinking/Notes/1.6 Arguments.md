...
idea - reasons
- justify / explain ourselves
- evaluate others
- convince others
- can be retrospective / prospective (example for each)

idea - arguments
- when we reason to claim or conclude som, we are engaged in argument (not assertion, whats the difference?)

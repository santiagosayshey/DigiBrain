...
4. **Cherry-picking + Circular reasoning**: He highlights Flight 19 and USS Cyclops while dismissing vessels found with survivors as less important. Then he draws the Triangle's boundaries based on where these cherry-picked disappearances occurred - essentially defining the danger zone by the very incidents he's trying to explain. Different authors draw different shapes because they're just connecting different incidents.
5. **False dichotomy/Ignoratio Elenchi**: The entire argument rests on "the ocean is mysterious, therefore the Triangle is supernatural." But deep-sea creatures don't explain compass failure at 10,000 feet. Atlantis doesn't explain radio static. Even if EVERY ocean mystery he mentions were true, they're completely irrelevant to his actual claim about ships and planes disappearing. It's a massive non sequitur dressed up as evidence.
6. **Texas Sharpshooter fallacy**: Berlitz retroactively imposes patterns on unrelated disappearances spanning decades. He finds "common elements" - compass failures, good weather, no wreckage - and presents these as evidence of a mysterious force. But compass problems are routine in aviation (thousands land safely with them), good weather disappearances happen globally, and finding no wreckage is the norm for deep ocean accidents everywhere. He's essentially looking at random maritime tragedies and connecting dots that aren't there, like finding faces in clouds. Any ocean region would show these same "patterns" if you cherry-picked only unsolved cases and ignored routine explanations. The "pattern" exists only because he's looking backwards at accidents that already happened and forcing connections between them.
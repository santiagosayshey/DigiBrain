...
I would like your assistance in writing concise, modular notes on the topic of [symbolic execution] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
please go in depth for these two callouts, perhaps a mermaid diagram could be beneificial here 

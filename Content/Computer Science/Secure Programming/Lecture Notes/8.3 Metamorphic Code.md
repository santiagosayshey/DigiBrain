...
I would like your assistance in writing concise, modular notes on the topic of [metamorphic code] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
please use this additional context to write the proper note.

...
Hey, thanks for entertaining my random message! 3D imaging sounds really cool—did you get to work on any fun projects for it?

My favorite class so far has been computer systems - I guess it kind of spoke to me? in a way that i never expected something academic could. 

There was one chapter on function call & return that really stuck with me—how functions are abstracted as single values at the lower level, and how the actual work behind them stays hidden to other functions. I tend to be a very anxious person, so this realisation that there's a whole world of thought outside of the result we can see was very therapeutic. I just felt like I belonged in that class, if that makes sense. Have you taken comp systems yet? :)

Outside of that, im taking some philosophy classes this semester to round out my electives, and I think those are going to be really interesting.
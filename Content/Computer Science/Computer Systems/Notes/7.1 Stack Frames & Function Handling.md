...
My favorite class so far has been computer systems—I guess it just spoke to me in a way I never expected something academic could.

There was one chapter on function call & return that really stuck with me—how functions are abstracted as single values at the lower level, and how the actual work behind them stays hidden. I tend to be quite anxious, so that realization—that there’s a whole world of thought outside the results we see—was surprisingly therapeutic. I just felt like I belonged in that class, if that makes sense.

Have you taken comp systems yet? :)

Outside of that, I’m taking some philosophy classes this semester to round out my electives, and I think they’re going to be really interesting.
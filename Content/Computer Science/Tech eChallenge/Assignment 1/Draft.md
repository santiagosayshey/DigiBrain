...
|---|---|---|---|
|**1. Ingest & Structure**|Accepts raw content and segments it into structural parts with paragraph tags and argument markers.|**Job 1** (grasp key concepts)|**Functional**: Prepares content for analysis, isolating key ideas.**Emotional**: Reduces cognitive overload by making the document less intimidating.**Social**: _None_|
|**2. Summarise & Sentence Breakdown**|Generates short gists for each paragraph and splits them into manageable sentences.|**Job 1**|**Functional**: Clarifies core content rapidly.**Emotional**: Provides a sense of accomplishment and clarity early in the process.**Social**: _None_|
|**3. Visual Tagging & Drafting**|Assigns image tags to each sentence, combines them into a draft transcript, and interpolates between sentences to create narrative flow.|**Job 1 & Job 2**|**Functional**: Builds a structured base for communication.**Emotional**: Increases confidence in handling and reshaping complex content.**Social**: _None_|
|**4. Language Polishing**|Uses AI to enhance grammar, style, and clarity for improved readability and tone.|**Job 1 & Job 2**|**Functional**: Ensures clear, concise communication.**Emotional**: Reinforces confidence that the explanation will be well-received.**Social**: _None_|
|**5. Voice & Image Generation**|Generates voice narration from the final script and AI images from sentence tags.|**Job 2**|**Functional**: Adds audio-visual clarity.**Emotional**: Reduces anxiety about losing audience attention; increases satisfaction in the output.**Social**: Enhances perception as a skilled and engaging communicator.|
|**6. Video Synthesis**|Interpolates between images to build visual transitions, aligns visuals with narration, and outputs the final video.|**Job 2**|**Functional**: Delivers a polished, ready-to-share video.**Emotional**: Provides pride and relief at producing a coherent result.**Social**: Demonstrates fluency in communicating complex ideas with modern tools.|

...
The following table details Synapsis's features and how they address the previously identified jobs. Each feature is designed to support both quick comprehension of research content and effective knowledge sharing.

|**Feature**|**What It Does**|**Jobs Addressed**|**Goals Fulfilled**|
|---|---|---|---|
|**1. Take Text**|Accepts raw content (e.g., a research paper) as the starting point.|**Job 1** (quick comprehension)|**Functional**: Provides the gateway for further processing.<br>**Emotional**: _None_<br>**Social**: _None_|
|**2. Identify Structural Paragraphs & Tags**|Recognizes distinct sections and argument markers in the document.|**Job 1** (pinpoint core arguments)|**Functional**: Makes analysis more efficient by isolating key sections.<br>**Emotional**: _None_<br>**Social**: _None_|
|**3. Generate Gist of Paragraphs**|Produces concise statements that capture each paragraph's central idea.|**Job 1** (highlight essential info)|**Functional**: Cuts down reading time.<br>**Emotional**: Eases worry about missing key points.<br>**Social**: _None_|
|**4. Break Gists into Sentences**|Splits these brief summaries into single-sentence units for easier handling.|**Job 1** (further clarity)|**Functional**: Improves structure for subsequent steps.<br>**Emotional**: Minimizes frustration in parsing content.<br>**Social**: _None_|
|**5. Generate Image Tag for Each Sentence**|Assigns a short descriptive label to guide future image creation.|**Job 2** (visual support for explanations)|**Functional**: Provides a clear link between text and visuals.<br>**Emotional**: Sparks a sense of creativity.<br>**Social**: _None_|
|**6. Combine Sentences into Draft Transcript**|Merges individual sentences into a coherent script for review.|**Job 1 & Job 2** (organizes content for quick grasp and sharing)|**Functional**: Offers a single narrative flow.<br>**Emotional**: Encourages a feeling of control over the material.<br>**Social**: _None_|
|**7. Interpolate Between Sentences**|Adds connecting phrases for smoother transitions in the script.|**Job 2** (fosters clear communication)|**Functional**: Makes the text more readable.<br>**Emotional**: Reduces anxiety about choppy delivery.<br>**Social**: _None_|
|**8. Run Draft Through AI for Better Language**|Refines grammar and style in the draft to enhance overall clarity.|**Job 1 & Job 2** (both internal understanding and outward presentation)|**Functional**: Ensures professional language.<br>**Emotional**: Boosts confidence in the final text.<br>**Social**: _None_|
|**9. Run Transcript Through AI Voice**|Converts the polished script into spoken audio, creating a narrated track.|**Job 2** (effective knowledge sharing)|**Functional**: Adds an auditory layer to the summary.<br>**Emotional**: Inspires enthusiasm for engaging content.<br>**Social**: Elevates perception of tech-savviness when shared with colleagues or audiences.|
|**10. Generate AI Images from Tags**|Transforms text-based cues into matching visuals.|**Job 2** (making dense info accessible to various audiences)|**Functional**: Provides clear illustration of complex points.<br>**Emotional**: Creates a sense of accomplishment in conveying ideas visually.<br>**Social**: Demonstrates innovative communication skills.|
|**11. Interpolate Between Images**|Creates transitional frames between images to ensure smooth scene changes.|**Job 2** (enhances narrative flow for presentations)|**Functional**: Produces a fluid video sequence.<br>**Emotional**: Avoids the jarring effect of abrupt visuals.<br>**Social**: Projects competence in creating polished, professional materials.|
|**12. Combine Video and Transcript**|Synchronizes the narrated audio track with the sequence of images.|**Job 2** (ready-to-share, visually engaging summary)|**Functional**: Delivers a fully packaged video.<br>**Emotional**: Provides relief from tedious manual syncing.<br>**Social**: Showcases the user's expertise in delivering well-structured multimedia content.|
|**13. Output Final Product**|Produces the completed video summary, integrating audio narration and visuals into a concise presentation.|**Job 1 & Job 2** (personal comprehension + public communication)|**Functional**: Gives a fully usable end result.<br>**Emotional**: Offers satisfaction and reduced mental load.<br>**Social**: Reinforces the user's standing as an efficient, clear communicator of complex material.|

Each feature in the Synapsis pipeline contributes to fulfilling both the functional goals (efficiency, time-saving, organisation) and the emotional goals (reduced stress, increased confidence) while supporting social goals like demonstrating research efficiency and enhancing one's reputation as an effective communicator.

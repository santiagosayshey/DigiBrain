...
I would like your assistance in writing concise, modular notes on the topic of [Logistic Regression] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
im giving you free reign to do whatever callouts you deem nessecary here, but i would liketo understand what the problem with linear models are, why we add logistic functions (sigmoids) to them to get logisitc models and what this fixes. i want to underst

...
>
> It's worth noting that Scikit-Learn's `Perceptron` class implements a basic Perceptron algorithm. It's a linear classifier and, unlike models like Logistic Regression, doesn't output class probabilities and applies no regularization by default.
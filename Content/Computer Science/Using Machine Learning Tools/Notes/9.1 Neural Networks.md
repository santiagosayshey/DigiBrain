...
| --------- | ---------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1         | Idea             | Perceptrons           | Link back to the intial binary neuron, say this is better version of it.<br>- uses TLUs. explain what the difference is (numbers vs binary, includes wights and bias). computes a linear function of these weighted inputs then applies a step function to it<br>- what is a step function (it transforms the output such that....., so that.....). Give examples of step functions - heaviside.<br>-  |

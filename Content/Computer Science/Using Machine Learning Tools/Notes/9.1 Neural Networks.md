...
> [!idea] Perceptrons
> A perceptron is a simple neural network where:
> - Multiple TLUs are arranged in a single layer
> - All inputs connect directly to all TLUs (fully connected)
> - Each TLU produces one output of the network
> 
> **Visual Representation:**
> ![[Pasted image 20250513032343.png|500]]
>
> **Applications:**
> - Each TLU creates its own decision boundary
> - Ideal for multi-class problems with n classes (using n TLUs)
> - Processes inputs in parallel rather than sequentially
>
> Despite their power for simple tasks, perceptrons cannot solve problems that aren't linearly separable (like XOR logic)—a limitation that led to the development of multi-layer networks.

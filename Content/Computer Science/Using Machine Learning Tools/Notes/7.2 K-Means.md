...
>
> ```image_goes_here
> Caption: Figure 9-6. Comparison of Mini-Batch K-Means and K-Means.
> Description: Two plots. Left plot: Compares inertia values for Mini-Batch K-Means and regular K-Means across different numbers of clusters (k). Mini-Batch K-Means consistently shows slightly higher inertia. Right plot: Compares training time for both algorithms across different k values. Mini-Batch K-Means shows significantly faster training times, especially as k increases.
> ```

...
- **Topic for Notes:** `[Multilayer Perceptron]`
...
| --------- | ---------------- | --------------------- | ------------------------------------------------------------------------------------------------------ |
| 1         | Motivation       | Single is Too Simple  | Talk about why single layer perceptrons are too simple (the XOR problem) and introduce a need for..... |
| 2         | Idea             |                       |                                                                                                        |

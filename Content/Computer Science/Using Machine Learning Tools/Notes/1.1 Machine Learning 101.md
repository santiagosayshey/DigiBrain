...
> 
> Machine learning algorithms can be categorized into two fundamental approaches based on how they learn from data.
> 
> |Approach|Core Mechanism|Example Algorithms|
> |---|---|---|
> |Example-based|Stores training examples in memory and makes predictions by comparing new instances to stored examples|k-Nearest Neighbors, Case-Based Reasoning, Support Vector Machines|
> |Model-based|Creates a mathematical model that captures patterns in training data and uses the model for predictions|Linear Regression, Neural Networks, Random Forests|
> 
> **Example-based learning:**
> 
> - Makes predictions by measuring similarity between new data and stored examples
> - Typically requires minimal preprocessing but larger memory footprint
> - Often described as "learning by analogy" or "lazy learning"
> 
> **Model-based learning:**
> 
> - Creates an internal representation (model) that summarizes data patterns
> - Discards training data after model construction
> - More computationally efficient at prediction time but requires upfront training
> 
> Both approaches convert experiences (data) into knowledge, but differ in when and how computation occurs.

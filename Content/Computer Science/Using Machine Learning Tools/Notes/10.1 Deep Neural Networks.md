...
| --------- | ---------------- | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1         | Motivation       | More Complexity           | We want to talk about how the only NN we've looked at so far have are tiny. what if we want to detect hundreds of objects in super high definition images? |
| 2         | Idea             | Deep Neural Networks      | Present DNNs as a solution to this problem, then explain what it is.                                                                                       |
| 3         | Consider         | It's Harder Than it Looks | training DNNs is hard. vanishing / exploding gradients. not enough training data, slow traning, severe overfitting.                                        |

i will give more after this, bu

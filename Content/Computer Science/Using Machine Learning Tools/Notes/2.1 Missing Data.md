...
I would like your assistance in writing concise, modular notes on the topic of [Missing Data] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
missing data in the context of ml learning.

what can we do? remove data, but this is

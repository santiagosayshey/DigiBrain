...
I would like your assistance in writing concise, modular notes on the topic of [Regression Performance Metrics] The goal is to create notes that are easy to understand and focused on key ideas rather than verbatim copying from textbooks. 
...
motivation - explain why we would to measure the performance of regression models
ideas for - root mean squared error, mean absoluyte error, median / max error, r^2 / corellation coefficient

for aech of the ideas, i want a basic explanation of what theyre doing and what theyre good at. THEN seperateraly i want the the maths explained - the formula stated, then explained in laymans terms what its actyually measuring

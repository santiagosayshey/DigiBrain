...
- add to previous callout small # of extent. what is this?

consider - linked allocation
- linked list of fixed size blocks (multiple sectors)
- array mermaid diagram with arrows pointing to fragmented linked list
- no external frag, but lots of internal
- can grow easily
- waste pointer per block


consider- file allocation table (FAT)
- still uses linked lists
- how does it differ?
- diagram

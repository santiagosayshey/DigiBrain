...
| Neural Matrix Clusters   | These clusters of quantum-entangled neural tissue form the basis of the ant colony's hivemind. Each cluster contains three distinct neural structures: <br>- Synaptic Resonators: Primary quantum computation nodes<br>- Entanglement Cores: Maintain quantum coherence across distances<br>- Memory Strands: Store and transmit colony information<br><br>These clusters must be recycled down into these components but with a small cavet: the recycling process is incredibly harsh on the delicate tissues - theres only x% chance you get some materials. | When recycled, yields ONE of:<br>- 1 Synaptic Resonator (40%)<br>- 1 Entanglement Core (35%)<br>- 1 Memory Strand (25%) |

...
With that being said, go check out the new website: https://dictionarry.dev/. It's built using next.js 15, rebuilds itself whenever my proprietary database: https://github.com/Dictionarry-Hub/database receives an update